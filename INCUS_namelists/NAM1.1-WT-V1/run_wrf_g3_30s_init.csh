...
#PBS -V
#PBS -q smd_ops
#PBS -lselect=110:ncpus=28:mpiprocs=28:model=bro_ele,walltime=96:00:00
#PBS -l site=static_broadwell
#PBS -W group_list=s2841
#PBS -j oe
#PBS -o wrf_mpt_init.log
#PBS -e wrf_error_init.log
#PBS -N NAM1.1_WT_G3_30S_INIT
#PBS -m be
#PBS -r n
...
several_tries mpiexec -np 3080 ./wrf.exe >& wrf.exe.out_NAM1.1_WT-G3_30S_INIT
